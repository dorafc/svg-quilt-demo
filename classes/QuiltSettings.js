...
class QuiltSettings{
  constructor(quiltID, spaceNameID, dimensions, colorPalette, blockTypes, matchEdges, startSeeds, matchFallback, recursiveBlock, showSeam, debugging){
    ...
    this.startSeeds = startSeeds              // number of starting seeds for generating blocks
